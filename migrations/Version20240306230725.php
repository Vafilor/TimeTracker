...
final class Version20240306230725 extends TimeTrackerMigration
{
    ...
    public function upPostgresql(Schema $schema): void
    {
        ...
        $this->addSql('COMMENT ON COLUMN note.id IS \'\'');
        $this->addSql('COMMENT ON COLUMN note.assigned_to_id IS \'\'');

        $this->addSql('ALTER TABLE statistic ALTER id TYPE UUID');
        $this->addSql('ALTER TABLE statistic ALTER assigned_to_id TYPE UUID');
        $this->addSql('COMMENT ON COLUMN statistic.id IS \'\'');
        $this->addSql('COMMENT ON COLUMN statistic.assigned_to_id IS \'\'');
        ...
        $this->addSql('COMMENT ON COLUMN statistic_value.id IS \'\'');
        $this->addSql('COMMENT ON COLUMN statistic_value.statistic_id IS \'\'');
        $this->addSql('COMMENT ON COLUMN statistic_value.time_entry_id IS \'\'');
        $this->addSql('COMMENT ON COLUMN statistic_value.timestamp_id IS \'\'');
        ...
        $this->addSql('COMMENT ON COLUMN tag.assigned_to_id IS \'\'');
        ...
        $this->addSql('COMMENT ON COLUMN tag_link.time_entry_id IS \'\'');
        $this->addSql('COMMENT ON COLUMN tag_link.timestamp_id IS \'\'');
        $this->addSql('COMMENT ON COLUMN tag_link.tag_id IS \'\'');
        $this->addSql('COMMENT ON COLUMN tag_link.task_id IS \'\'');
        $this->addSql('COMMENT ON COLUMN tag_link.statistic_id IS \'\'');
        $this->addSql('COMMENT ON COLUMN tag_link.note_id IS \'\'');
        ...
        $this->addSql('COMMENT ON COLUMN task.assigned_to_id IS \'\'');
        $this->addSql('COMMENT ON COLUMN task.parent_id IS \'\'');
        ...
        $this->addSql('COMMENT ON COLUMN time_entry.id IS \'\'');
        $this->addSql('COMMENT ON COLUMN time_entry.assigned_to_id IS \'\'');
        $this->addSql('COMMENT ON COLUMN time_entry.task_id IS \'\'');

        $this->addSql('ALTER TABLE timestamp ALTER id TYPE UUID');
        $this->addSql('ALTER TABLE timestamp ALTER assigned_to_id TYPE UUID');
        $this->addSql('COMMENT ON COLUMN timestamp.id IS \'\'');
        $this->addSql('COMMENT ON COLUMN timestamp.assigned_to_id IS \'\'');
