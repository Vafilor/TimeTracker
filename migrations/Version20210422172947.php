 ...
 */
final class Version20210422172947 extends AbstractMigration
{
    public function getDescription() : string
    {
        return 'Adds today_date_format to users to keep track of format dates in the today section should be shown.';
    }

    protected function upPostgresql(Schema $schema) : void
    {
        $this->addSql('ALTER TABLE users ADD today_date_format VARCHAR(255)');
        $this->addSql("UPDATE users SET today_date_format = 'h:i:s A'");
        $this->addSql('ALTER TABLE users ALTER COLUMN today_date_format SET NOT NULL');
    }

    protected function downPostgresql(Schema $schema) : void
    {
        $this->addSql('ALTER TABLE users DROP today_date_format');
    }
    ...
    protected function upMysql(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users ADD today_date_format VARCHAR(255) NOT NULL');
    }
    ...
    protected function upSqlite(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users ADD COLUMN today_date_format VARCHAR(255) NOT NULL');
    }
    ...
    protected function downSqlite(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__users AS SELECT id, password_requested_at, is_verified, timezone, date_format, duration_format, email, username, enabled, confirmation_token, roles, password FROM users');
        ...
        $this->addSql('INSERT INTO users (id, password_requested_at, is_verified, timezone, date_format, duration_format, email, username, enabled, confirmation_token, roles, password) SELECT id, password_requested_at, is_verified, timezone, date_format, duration_format, email, username, enabled, confirmation_token, roles, password FROM __temp__users');
